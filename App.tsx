...
const App: React.FC = () => {
  ...
  const renderSectionContent = (section: any) => {
    ...
    if (section.id === 'waste') {
      ...
      const intro = parts[0];
      const locations = parts.slice(1, 3);
      const bins = parts.slice(3);
      return (
          ...
          <div className="grid grid-cols-1 gap-3">
            {bins.map((bin: string, idx: number) => {
              ...
              if (colorName.toLowerCase().includes('giallo') || colorName.toLowerCase().includes('yellow') || colorName.toLowerCase().includes('gelb') || colorName.toLowerCase().includes('jaune') || colorName.toLowerCase().includes('amarillo')) {
                colorClass = 'bg-yellow-50 border-yellow-200 text-yellow-800'; iconColor = 'text-yellow-500';
                ...
                colorClass = 'bg-blue-50 border-blue-200 text-blue-800'; iconColor = 'text-blue-500';
                ...
                colorClass = 'bg-emerald-50 border-emerald-200 text-emerald-800'; iconColor = 'text-emerald-500';
                ...
                colorClass = 'bg-amber-50 border-amber-200 text-amber-900'; iconColor = 'text-amber-700';
                ...
                colorClass = 'bg-stone-100 border-stone-300 text-stone-600'; iconColor = 'text-stone-500';
              }
              return (
      ...
      <div className="px-6 py-10 space-y-10">
        ...
        <div className="space-y-5">
          {data.sections.map((section) => {
            ...
            return (
              <div key={section.id} className={`bg-white rounded-[2.5rem] border overflow-hidden transition-all duration-300 ${
